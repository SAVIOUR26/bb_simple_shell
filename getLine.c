...
/**
 * get_input - this  gets the line minus newline
...
/**
 * read_buf - this reads the buffer
 ...
 * @info: the parameter structure
 * @ptr: the address of pointer 2 buffer, preallocated or NULL
 * @length: the size of preallocated ptr buffer else NULL
 *
 * Return: s
 */
