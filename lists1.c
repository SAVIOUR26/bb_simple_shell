 ...
 * @h: the pointer 2 the first node
 *
...
/**
 * list_to_strings - this returns an array of the strings of list->str
...
/**
 * node_starts_with - this returns a node whose string starts with the prefix
