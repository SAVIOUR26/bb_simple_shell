 ...
 *
 * Return: on success 0, on error 1,  else error code
 */
...
/**
 * find_cmd - this finds the cmd in PATH
 * @info: parameter and return info structure
 *
 * Return: nothing
 */
...
/**
 * fork_cmd - this forks the exec thread to run command
